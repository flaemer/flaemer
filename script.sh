...
amd_pc="grub efibootmgr swww yt-dlp networkmanager ly foot xwayland-satellite fastfetch btop mesa mesa-utils wl-clipboard pipewire pipewire-pulse wireplumber"
